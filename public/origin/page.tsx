      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="rounded-3xl border border-amber-300/20 bg-white/[0.03] p-8">
            ...
            <h3 className="mt-5 font-serif text-5xl text-stone-50">1634</h3>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-6 text-lg text-stone-300">Prince-Abbot</p>
    ...
    <p className="font-semibold text-amber-200">
      Les Shypka
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-6 text-lg text-stone-300">Cardinal-Abbot</p>
            <img
